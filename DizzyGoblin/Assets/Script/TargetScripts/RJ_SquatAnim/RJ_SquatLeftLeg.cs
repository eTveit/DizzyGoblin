...
public class RJ_SquatLeftLeg : IKAnimationTarget
{
    ...
    */
    ...
    private Segment3d thighL;
    private Segment3d calfL;
    private Segment3d footL;
    ...
    void Start()
    {
        ...
        goblinGlobals = AvatarObj.GetComponent<GoblinGlobals>();
         ...
         thighL = goblinGlobals.Search(AvatarObj, "Thigh_L").GetComponent<Segment3d>();
         calfL = goblinGlobals.Search(AvatarObj, "Calf_L").GetComponent<Segment3d>();
         footL = goblinGlobals.Search(AvatarObj, "Foot_L").GetComponent<Segment3d>();
