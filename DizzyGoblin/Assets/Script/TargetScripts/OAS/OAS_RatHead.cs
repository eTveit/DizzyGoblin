...
public class OAS_RatHead : IKAnimationTarget
{
    ...
    */
    ...
    Vector3[] keyframes = new[] { new Vector3(0.0f, 7.55f, 0.1300001f), new Vector3(0.75f, 7.55f, -0.174f), new Vector3(0.23f, 7.55f, 0.13f), new Vector3(-0.276f, 7.55f, 0.13f)   };
