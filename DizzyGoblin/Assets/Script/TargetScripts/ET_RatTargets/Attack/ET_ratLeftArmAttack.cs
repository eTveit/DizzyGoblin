...
public class ET_ratLeftArmAttack : IKAnimationTarget {
    ...
    */
    ...
    void Start() {
        ...
        positions[2] = new Vector3(-1.7f, 2.2f, 2.0f);
        positions[3] = new Vector3(-3.25f, 4.65f, 2.15f);
        positions[4] = new Vector3(1.75f, 2.6f, 3.1f);
