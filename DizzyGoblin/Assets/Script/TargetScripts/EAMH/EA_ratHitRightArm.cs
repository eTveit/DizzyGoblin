...
public class EA_ratHitRightArm : IKAnimationTarget
{
    ...
    */
	...
	Vector3[] keyframes = new [] { new Vector3(4.0f,3.0f,0.0f), new Vector3(9.0f,2.0f,7.0f), new Vector3(1.0f,3.0f,1.0f) };
