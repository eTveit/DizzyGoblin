...
public class OAS_RatRightArm : IKAnimationTarget
{
    ...
    */
    ...
    Vector3[] keyframes = new[] { new Vector3(2.58f, 2.34f, 0.0f), new Vector3(2.114f, 2.34f, 0.0f), new Vector3(2.905f, 3.414f, 1.425f)  };
