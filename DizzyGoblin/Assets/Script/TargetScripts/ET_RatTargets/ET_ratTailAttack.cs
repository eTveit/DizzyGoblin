...
public class ET_ratTailAttack : IKAnimationTarget {
    ...
    */
    ...
    void Start() {
        ...
        positions[1] = new Vector3(4.25f, 4, -4.7f);
        positions[2] = new Vector3(-2.3f, 2.1f, -4.4f);
        positions[3] = new Vector3(-3.3f, 3.1f, -4.4f);
        positions[4] = new Vector3(2.7f, 2.7f, -4.2f);
    ...
    void Update() {
        ...
        // giving the tail a more irregular movement
        adjust *= UnityEngine.Random.Range(0.2f, 1.8f);
