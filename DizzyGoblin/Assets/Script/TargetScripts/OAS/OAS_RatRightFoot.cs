...
public class OAS_RatRightFoot : IKAnimationTarget
{
    ...
    */
    ...
    Vector3[] keyframes = new[] { new Vector3(0.75f, -0.068f, -0.32f), new Vector3(0.75f, -0.068f, -0.32f), new Vector3(0.95f, -0.068f, 0.06f)   };
